...
function cadastrarProduto(req, res) {
    try {
        ...
        let endereco = new Endereco_1.Endereco(data.fabricante.endereco.cidade, data.fabricante.endereco.pais);
        let fab = new Fabricante_1.Fabricante(data.fabricante.nome, endereco);
        let produto = new Produto_1.Produto(PrId++, data.nome, data.preco, fab); //mpedir id duplicado;
...
function atualizarProduto(req, res) {
    try {
        ...
        let endereco = new Endereco_1.Endereco(data.fabricante.endereco.cidade, data.fabricante.endereco.pais);
        let fab = new Fabricante_1.Fabricante(data.fabricante.nome, endereco);
        let produto = new Produto_1.Produto(parseInt(id), data.nome, data.preco, fab);
